...
const sections: Section[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Open Companion in je browser en ga naar Connections → Add connection → zoek "HTTP Variable".',
      'Plak de gekopieerde URL in het veld "URL" en stel het interval in op 500 ms.',
      'Sla op — Companion haalt nu elke 500 ms de actieve cue op.',
      'Gebruik $(http-variable:body_active_cue_title) in een knoplabel om de actieve cue te tonen.',
      'Andere beschikbare velden: body_next_cue_title, body_active_cue_type, body_cues_done, body_cues_total.',
    ],
