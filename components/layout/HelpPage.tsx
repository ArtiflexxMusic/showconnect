...
const sections: Section[] = [
  ...
  },
  {
    ...
    icon: Webhook,
    color: 'pink',
    title: 'Companion Webhook',
    subtitle: 'Integratie met Bitfocus Companion',
    description:
      'Stuur automatisch een HTTP-bericht naar Bitfocus Companion elke keer dat een cue start. Zo kun je lichten, geluid, switchers en andere apparatuur laten reageren op GO — zonder handmatige acties.',
    steps: [
      'Stel in Bitfocus Companion een HTTP-trigger in en kopieer de webhook URL.',
      'Plak de URL in Rundown Instellingen → "Companion Webhook URL".',
      'Elke keer dat de Caller op GO drukt, wordt de webhook automatisch verstuurd.',
    ],
    tip: 'Zie de Bitfocus Companion documentatie voor het instellen van HTTP-triggers op jouw StreamDeck.',
    badge: 'Integratie',
  },
]
